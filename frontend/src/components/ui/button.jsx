  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-2 border-border bg-background text-foreground shadow-sm hover:bg-secondary hover:border-primary/50",
        secondary:
        ...
        premium:
          "bg-gradient-to-r from-primary to-accent text-primary-foreground shadow-md hover:shadow-glow hover:-translate-y-0.5",
        gold:
          "bg-gradient-to-r from-gold to-gold-light text-foreground shadow-gold hover:shadow-lg hover:-translate-y-0.5",
        elegant:
          "bg-card border border-border text-foreground shadow-sm hover:border-primary hover:shadow-md",
      },
      size: {
